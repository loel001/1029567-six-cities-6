...
describe(`Reducers work correctly`, () => {
  ...
  it(`Reducer should update favorite place`, () => {
    ...
    const updatedFavoritePlaces = changeFavoritePlaces(places, place);
    const updatedPlaces = updatePlaces(places, place);
    const updatedNearPlaces = updateNearPlaces(places, place);
    ...
    expect(data(state, updateFavoritePlace(place)))
      .toEqual({
        places: updatedPlaces,
        favoritesPlaces: updatedFavoritePlaces,
        nearPlaces: updatedNearPlaces
      });
  });
